...
#include "am_bsp.h"         // NOLINT // Maybe this needs to be updated to the redboard one https://github.com/aczhang9/SparkFun_Apollo3_AmbiqSuite_BSPs/blob/master/redboard_artemis/bsp/am_bsp.h
...
TfLiteStatus InitAudioRecording(tflite::ErrorReporter* error_reporter) {
  ...
  if (am_hal_cachectrl_control(AM_HAL_CACHECTRL_CONTROL_FLASH_ALL_SLEEP_ENABLE,
